import { normalizeDocumentLine, splitGluedOrdinalPrefix, stripListPrefix, } from './classifyDocumentLine.js';
/**
 ...
 */
export function formatObservationFragment(raw) {
...
export function normalizeObservationBlock(text) {
    const lines = text
        .split(/\r?\n/)
...
//# sourceMappingURL=observationTextFormatting.js.map