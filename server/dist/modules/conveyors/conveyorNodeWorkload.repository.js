 ...
 */
export async function listStepHierarchyForConveyor(pool, conveyorId) {
    ...
    return r.rows.map((row) => ({
        ...
        planned_minutes: row.planned_minutes == null || row.planned_minutes === ''
            ? null
...
export async function sumRealizedMinutesByStepForConveyor(pool, conveyorId) {
    const r = await pool.query(`
...
//# sourceMappingURL=conveyorNodeWorkload.repository.js.map