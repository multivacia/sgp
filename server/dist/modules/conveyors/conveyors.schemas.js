...
export const postConveyorStepSchema = z
    ...
    if (collaboratorRows.length > 0 && prim.length !== 1) {
        ctx.addIssue({
            code: z.ZodIssueCode.custom,
            message: 'Cada etapa com colaboradores deve ter exatamente um responsável principal.',
            path: ['assignees'],
        });
    }
...
const emptyQueryToUndef = (v) => v === '' || v === undefined ? undefined : v;
...
export const getConveyorsQuerySchema = z.object({
    ...
    priority: z.preprocess(emptyQueryToUndef, z.enum(['alta', 'media', 'baixa']).optional()),
    responsible: z.preprocess(emptyQueryToUndef, z.string().min(1).optional()),
    operationalStatus: z.preprocess(emptyQueryToUndef, conveyorOperationalStatusQueryEnum.optional()),
});
...
//# sourceMappingURL=conveyors.schemas.js.map