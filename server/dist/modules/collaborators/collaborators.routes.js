...
import { getCollaboratorById, getCollaborators, patchCollaborator, postActivate, postCollaborator, postInactivate, } from './collaborators.controller.js';
...
export function collaboratorsRouter() {
    const r = Router();
    r.get('/collaborators', ...auth, asyncRoute(getCollaborators));
    r.get('/collaborators/:collaboratorId/operational-journey', ...authJourney, asyncRoute(getOperationalJourney));
