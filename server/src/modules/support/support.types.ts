export const SUPPORT_TICKET_STATUS = ['OPEN', 'IN_PROGRESS', 'RESOLVED', 'CLOSED'] as const
export type SupportTicketStatus = (typeof SUPPORT_TICKET_STATUS)[number]

export const SUPPORT_TICKET_SEVERITY = ['LOW', 'MEDIUM', 'HIGH', 'CRITICAL'] as const
export type SupportTicketSeverity = (typeof SUPPORT_TICKET_SEVERITY)[number]

export const SUPPORT_NOTIFICATION_CHANNEL = ['EMAIL', 'WHATSAPP'] as const
export type SupportNotificationChannel = (typeof SUPPORT_NOTIFICATION_CHANNEL)[number]

export const SUPPORT_NOTIFICATION_STATUS = ['PENDING', 'SENT', 'FAILED', 'SKIPPED'] as const
