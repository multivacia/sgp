...
export async function patchTeam(req: Request, res: Response): Promise<void> {
  const id = uuidParamSchema.parse(req.params.id)
...
export async function patchTeamMember(req: Request, res: Response): Promise<void> {
  const teamId = uuidParamSchema.parse(req.params.teamId)
