...
/**
 * Bottom sheet com toda a interação de registro do apontamento do kiosk.
 * Componente puramente apresentacional (sem `createPortal` interno) para
 * permanecer testável via `renderToStaticMarkup` — o portal é montado por
 * `KioskActivityCard`, o único ponto que sabe se `sheetOpen` está ativo.
 */
