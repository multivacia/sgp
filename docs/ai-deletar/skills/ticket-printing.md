...
- Impressão de tickets deve ser direta.
- Outros documentos não devem perder preview.
- Agrupamentos previstos:
  - por tarefa;
  - por colaborador/responsável.
- Na impressão semanal, considerar atividades planejadas para o período.
- Na impressão dentro da esteira, considerar a estrutura da esteira selecionada.
- Cada atividade impressa deve ser cortada individualmente.
...
- acoplar regra de impressão a componente visual errado;
...
- impressão agrupada por colaborador;
